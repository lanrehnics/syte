package com.grandreynetwork.sytte.onboarder;
...
import com.grandreynetwork.sytte.onboarder.utils.ShadowTransformer;
import com.grandreynetwork.sytte.onboarder.views.CircleIndicatorView;
import com.grandreynetwork.sytte.onboarder.views.FlowingGradientClass;
...
public abstract class AhoyOnboarderActivity extends AppCompatActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    private LinearLayout btnContainers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnContainers = (LinearLayout) findViewById(R.id.btnContainers);
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.signin && isInLastPage) {
            onSignInButtonPressed();
        } else if (i == R.id.signup && isInLastPage) {
    ...
    private void showFinish() {
        ...
        this.btnContainers.animate().translationY(0 - dpToPixels(5, this)).setInterpolator(new DecelerateInterpolator()).setDuration(500).start();
    }
    ...
    private void hideFinish(boolean delay) {
        ...
        this.btnContainers.animate().translationY(this.btnContainers.getBottom() + dpToPixels(100, this)).setInterpolator(new AccelerateInterpolator()).setDuration(duration).setListener(new Animator.AnimatorListener() {
            @Override
    ...
    abstract public void onSignUpButtonPressed();

    abstract public void onSignInButtonPressed();
